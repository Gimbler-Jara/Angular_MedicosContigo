...
export const ENDPOINTS_CITAS = {
    ...
    REGISTRAR_DISPONIBILIDAD: "registrar-disponibilidad",
    CAMBIAR_ESTADO_DISPONIBILIDAd: "cambiar-estado-disponibilidad",
    AGENDAR_CITA: "agendar-cita",
    MEDICOS_POR_ESPECIALIDAD: "medicos-por-especialidad",
